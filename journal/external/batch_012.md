# External review batch 012

10 companies our local model could not read. Paste everything below the line into Gemini, then save its JSON reply as
`journal/external/batch_012_reply.json` and run:

    .venv\Scripts\python.exe -m clab.runner.ingest_external --file journal/external/batch_012_reply.json
...
THE COMPANIES
  SPNT - SiriusPoint Ltd.
    CIK 0001576018 | Financials / Reinsurance
  ...
  HFWA - HERITAGE FINANCIAL CORP /WA/
    CIK 0001046025 | Financials / Savings Institutions, Not Federally Chartered
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  HR - Healthcare Realty Trust
    CIK 0001360604 | Real Estate / Health Care REITs
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  SFNC - Simmons First National Corporation
    CIK 0000090498 | Financials / Regional Banks
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  MTZ - MasTec
    CIK 0000015615 | Industrials / Construction & Engineering
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  WWW - WOLVERINE WORLD WIDE INC /DE/
    CIK 0000110471 | Consumer Discretionary / Footwear, (No Rubber)
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  ARES - Ares Management
    CIK 0001176948 | Financials / Asset Management & Custody Banks
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  ROCK - GIBRALTAR INDUSTRIES, INC.
    CIK 0000912562 | Materials / Steel Works, Blast Furnaces & Rolling & Finishing Mills
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  EPC - EDGEWELL PERSONAL CARE Co
    CIK 0001096752 | Materials / Perfumes, Cosmetics & Other Toilet Preparations
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  GNL - Global Net Lease, Inc.
    CIK 0001526113 | Real Estate / Diversified REITs
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
