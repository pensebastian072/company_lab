# External review batch 003

10 companies our local model could not read. Paste everything below the line into Gemini, then save its JSON reply as
`journal/external/batch_003_reply.json` and run:

    .venv\Scripts\python.exe -m clab.runner.ingest_external --file journal/external/batch_003_reply.json
...
THE COMPANIES
  SM - SM Energy Company
    CIK 0000893538 | Energy / Oil & Gas Exploration & Production
  ...
  MGEE - MGE Energy, Inc.
    CIK 0001161728 | Utilities / Electric Utilities
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  FBRT - Franklin BSP Realty Trust, Inc.
    CIK 0001562528 | Real Estate / Diversified REITs
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  APA - APA Corporation
    CIK 0001841666 | Energy / Oil & Gas Exploration & Production
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  ARR - Armour Residential REIT
    CIK 0001428205 | Real Estate / Mortgage REITs
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  VNOM - Viper Energy
    CIK 0002074176 | Energy / Oil & Gas Storage & Transportation
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  CXW - CoreCivic
    CIK 0001070985 | Industrials / Diversified Support Services
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  LTC - LTC Properties, Inc.
    CIK 0000887905 | Real Estate / Health Care REITs
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  GFF - Griffon Corporation
    CIK 0000050725 | Industrials / Building Products
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
  ...
  EHC - Encompass Health
    CIK 0000785161 | Health Care / Health Care Facilities
    score these dimensions:
      - technological_advantage: Technological advantage
      - economies_of_scale: Economies of scale
      - switching_costs: Switching costs
