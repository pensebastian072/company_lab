...
| score v2 | 1472 | 58.26 | 50.0 | 59.0 | 67.0 | 87.0 |
| coverage v1 | 1472 | 0.87 | 0.82 | 0.9 | 0.95 | 1.0 |
| coverage v2 | 1472 | 0.95 | 0.94 | 0.98 | 1.0 | 1.0 |

Coverage gate 0.8: **1184 → 1410** of 1472.

| band | v1 | v2 |
|---|---:|---:|
| EXCEPTIONAL | 0 | 0 |
| HIGH_CONVICTION | 12 | 27 |
| INVESTABLE | 97 | 240 |
| WATCHLIST | 265 | 420 |
| WEAK | 325 | 417 |
| REJECT | 485 | 306 |
| INSUFFICIENT_DATA | 288 | 62 |

## Is it the same ranking?

* Spearman on `score`: **0.918**
* Spearman on `sector_neutral_score` (the cross-sector headline): **0.845**
* Same band: **541** of 1472 (**37%**)
* Top 50 by `sector_neutral_score`: **29 of 50 shared**
  * entered: CW, DIS, FORM, FSLR, GD, GEN, GMED, HQY, IT, JAZZ, MWA, MYRG, OSIS, PCTY, PEP, PRI, PTC, SANM, STX, TOST, TPR
  * left: ANET, AON, DELL, HSTM, KEYS, KLAC, KNSL, META, NFLX, PAYC, PSN, QLYS, RAMP, RL, RMD, SEIC, STRL, TEL, TT, ULS, ZWS

## By sector, most improved first

| sector | n | median score v1 → v2 | banded v1 → v2 | median coverage v1 → v2 |
|---|---:|---:|---:|---:|
| Energy | 70 | 41.0 → 53.0 | 57% → 77% | 0.819 → 0.947 |
| Real Estate | 102 | 35.0 → 47.0 | 43% → 94% | 0.793 → 0.957 |
| Consumer Staples | 74 | 49.5 → 60.0 | 92% → 100% | 0.915 → 0.989 |
| Communication Services | 47 | 51.0 → 61.0 | 79% → 81% | 0.883 → 0.957 |
| Financials | 255 | 48.0 → 58.0 | 78% → 98% | 0.864 → 0.978 |
...
| Industrials | 257 | 54.0 → 61.0 | 88% → 95% | 0.925 → 0.989 |
...
| 13 | FSS | Industrials | 75.0 → 77 | 100.0 → 100.0 | INVESTABLE |
| 14 | LRN | Consumer Discretionary | 73.0 → 80 | 100.0 → 100.0 | INVESTABLE |
| 15 | GMED | Health Care | 73.0 → 83 | 91.2 → 100.0 | HIGH_CONVICTION |
...
| 18 | AIZ | Financials | 74.0 → 66 | 100.0 → 100.0 | WATCHLIST |
