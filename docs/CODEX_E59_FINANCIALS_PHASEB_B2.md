# Codex E59 - Financials Phase B, batch 2 of 4

Company research over the 169 Financials companies that Phase A unblocked, in four
stratified batches. This is batch 2: **42 companies**, request_id
`b1d3275420b64cdb92f3`, depth 3, citations required. The roster was checked against the
...
batch. Do not evaluate E58 arm B after batch 2; two of four batches is not the full
Financials Phase B version scope.

## Prompt

`````
# COMPANY LAB - E59 PHASE B, FINANCIALS BATCH 2 OF 4
...
Company research. The request file is frozen and is the authority on what to research:
  ...
  request_id  b1d3275420b64cdb92f3
...
## THE ROSTER, by industry
  ...
  regional_banking                         11  ASB BANR CFG EBC FIBK GBCI HWC OFG SBCF TMP WABC
  asset_management_custody_banks            5  AAMI BEN FHI STEP WT
  investment_banking_brokerage              4  HLI LAZ PJT SNEX
  consumer_finance                          3  CACC ENVA PRG
  diversified_banks                         2  BAC TFC
  financial_exchanges                       2  CME NDAQ
  insurance_brokers                         2  AJG GSHD
  life_insurance                            2  JXN UNM
  mortgage_reits                            2  BXMT STWD
  multi_line_insurance                      2  AFG HMN
  reinsurance                               2  EG SPNT
  alternative_asset_management              1  ARES
  financial_data_ratings                    1  MORN
  pc_insurance                              1  EIG
  private_mortgage_insurance                1  ACT
  retirement_benefits                       1  VOYA
...
This is batch 2 of 4. Do not research companies from the other batches.
